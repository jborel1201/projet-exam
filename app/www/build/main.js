...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_images_images__ = __webpack_require__(196);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, alert, image) {
        this.navCtrl = navCtrl;
        this.alert = alert;
        this.image = image;
        this.imgList = [];
    }
    HomePage.prototype.selectFileToUpload = function (event) {
        var _this = this;
        this.image
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"D:\doc\ionic-pwa-test3\pwa3\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Upload\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-list>\n    <ion-item-sliding *ngFor="let img of imgList; let pos=index">\n      <ion-item>\n\n        <ion-thumbnail item-left>\n          <img src="{{img.src}}">\n        </ion-thumbnail>\n        {{img.name}}\n        <ion-icon name="arrow-round-back" item-right></ion-icon>\n\n      </ion-item>\n\n      <ion-item-options>\n        <button ion-button clear (click)="deleteImg(pos)">\n          <ion-icon name="trash" color="danger"></ion-icon>\n        </button>\n        <button ion-button clear (click)="addCom(img)">\n          <ion-icon name="chatbubbles"></ion-icon>\n        </button>\n      </ion-item-options>\n    </ion-item-sliding>\n  </ion-list>\n\n\n\n  <ion-fab right bottom>\n    <button ion-fab color="primary">\n      <input class="myFileInput" type="file" capture="environment" multiple id="fileInput"\n        (change)="selectFileToUpload($event)">\n      <label for="fileInput" icon-only>\n     \n      <ion-icon name="add"></ion-icon>\n       </label>\n    </button>  \n  </ion-fab>\n\n</ion-content>\n\n<ion-footer>\n\n</ion-footer>'/*ion-inline-end:"D:\doc\ionic-pwa-test3\pwa3\src\pages\home\home.html"*/
        }),
...
var ImagesProvider = /** @class */ (function () {
    function ImagesProvider(http) {
        this.http = http;
        this.remoteUri = "http://192.168.200.185:80/app/..."; // a voir
    }
    ImagesProvider.prototype.handleImageSelection = function (files) {
        var _this = this;
        this.filesList = [];
        var _loop_1 = function (file) {
            ...
            reader.onloadend = function () {
                _this.filesList.push(_this.fileRead);
            };
        };
        //[].forEach.call(files, this.readAndAddFile);
        for (var _i = 0, files_1 = files; _i < files_1.length; _i++) {
            var file = files_1[_i];
            _loop_1(file);
        }
        return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].create(function (observer) {
            observer.next(_this.filesList);
            observer.complete();
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_images_images__ = __webpack_require__(196);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__providers_images_images__["a" /* ImagesProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_home_home__ = __webpack_require__(195);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\doc\ionic-pwa-test3\pwa3\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"D:\doc\ionic-pwa-test3\pwa3\src\app\app.html"*/
        }),
